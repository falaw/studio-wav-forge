  ...
  return <motion.a href={project.youtubeUrl} target="_blank" rel="noopener noreferrer" initial={{
    ...
    delay: index * 0.1
      ...
      <div className="aspect-video bg-secondary overflow-hidden relative mb-4">
        ...
        {project.thumbnail ? <img src={project.thumbnail} alt={project.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" /> : <div className="w-full h-full bg-muted flex items-center justify-center text-4xl group-hover:scale-110 transition-transform duration-700">
            🎬
          </div>}
      </div>
  ...
  return <section id="work" className="py-32 px-6 md:px-12 bg-studio-bg-alt">
      <div className="max-w-7xl mx-auto">
        ...
        duration: 0.6
          ...
          <h2 className="section-header text-foreground px-0 mx-0 my-[27px]">SOUND DESIGN</h2>
        </motion.div>
