...
const PackCard = ({ pack, index, onClick }: PackCardProps) => {
  return (
    <motion.div
      ...
      onClick={onClick}
      className="pack-card cursor-pointer group"
    >
      {/* Image Container */}
      ...
      <div className="p-6 border-t border-foreground/5 bg-studio-card">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className={`text-xs font-bold tracking-widest uppercase ${
            pack.isFree ? 'text-green-500' : 'text-muted-foreground'
          }`}>
